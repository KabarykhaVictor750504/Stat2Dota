...
Фреймворки: VueJS 2, Spring Framework 5.0.
 ...
 # 3. Требования к интерфейсу
  ...
  # 4 Функциональные особенности системы
   ...
   - Возможность обрабатывать(получать информацию на веб-ресурсе OpenDota, после чего ее парсить) огромное количество матчей одновременно из-за реалазации многопоточности проекта;
